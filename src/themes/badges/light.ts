...
export const lightBadgeTheme: BadgeTheme = {
  ...
  sizes: {
    [Size.XS]: {
      minHeight: '16px',
      minWidth: '16px',
      /* Круг: одинаковый padding по осям — иначе при border-box ширина «раздувается» сильнее высоты */
      padding: '2px',
      fontSize: '10px',
      borderRadius: '8px',
      gap: '4px',
    ...
    [Size.LG]: {
      /* Увеличенный диаметр: при симметричном padding 8px нужна внутренняя область под шрифт 16px */
      minHeight: '36px',
      minWidth: '36px',
      padding: '8px',
      fontSize: '16px',
