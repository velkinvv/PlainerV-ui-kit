...
export const IconExMessageSquare: React.FC<IconComponentProps> = ({
  width = 24,
  height = 24,
  color: IconColor,
  ...props
  ...
  return (
    ...
    >
      <path
        ...
        fill={color}
      />
      <circle cx="7.05005" cy="11.0498" r="1.25" fill={color} />
      <circle cx="12.05" cy="11.0498" r="1.25" fill={color} />
      <circle cx="17.05" cy="11.0498" r="1.25" fill={color} />
    </svg>
  );
};

export default IconExMessageSquare;
