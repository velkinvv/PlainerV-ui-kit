...
export const IconExCamera: React.FC<IconComponentProps> = ({
  width = 24,
  height = 24,
  color: IconColor,
  ...props
  ...
  return (
    ...
    >
      <path
        ...
        strokeWidth="1.5"
      />
      <circle r="3" transform="matrix(-1 0 0 1 12 12.5)" stroke={color} strokeWidth="1.5" />
    </svg>
  );
};

export default IconExCamera;
