...
export const IconPlainerUser: React.FC<IconComponentProps> = ({
  width = 24,
  height = 24,
  color: IconColor,
  className,
  ...
  return (
    <svg
      ...
      {...props}
    >
      <circle r="4" transform="matrix(-1 0 0 1 12 7)" stroke={color} strokeWidth="1.5" />
      <path
...
export default IconPlainerUser;
