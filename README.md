...
**Текущая версия:** `0.3.1` · ветка [`v_0.3.1`](https://github.com/velkinvv/PlainerV-ui-kit/tree/v_0.3.1) · React 18+/19 · styled-components 6.x
...
npm i @velkinvv/plainerv@0.3.1 react react-dom styled-components framer-motion
```
...
Подробнее: [документация Theming](https://github.com/velkinvv/PlainerV-ui-kit/blob/v_0.3.1/documentation/content/docs/ru/web/v_0.3.1/theming.mdx) (на сайте: **Web → v0.3.1 → Theming**).
...
**Полный перечень публичных экспортов** — в [документации](https://github.com/velkinvv/PlainerV-ui-kit/blob/v_0.3.1/documentation/content/docs/ru/web/v_0.3.1/components-catalog.mdx) (на сайте: **Web → v0.3.1 → Справочник компонентов**). Ниже — краткая группировка.
